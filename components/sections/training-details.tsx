        ...
        <Card>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm list-disc pl-5">
              ...
              <li>Business advisory and consulting skills</li>
              <li>Professional software tools (Sage, Xero, QuickBooks)</li>
              <li>Client communication and relationship management</li>
              <li>Tax compliance and planning fundamentals</li>
            </ul>
          </div>
          ...
          <div className="mt-6">
            ...
            <ul className="space-y-2 text-sm list-disc pl-5">
              ...
              <li>Proficiency in MS Office and basic accounting software</li>
              <li>Commitment to professional development and learning</li>
            </ul>
          </div>
        </Card>
      </div>
